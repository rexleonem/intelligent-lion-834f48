            ...
            <div>
                ...
                <article>
                    ...
                    <div className="entry-content">
                        ...
                        <div className="entry-meta-top"><span className="entry-meta-category"><i className="far fa-folder"></i><a href="blog-three-col.html">Photography</a></span><span className="entry-author"><i className="far fa-user"></i>Dee Afrikan</span><span className="entry-meta-date"> <i className="far fa-clock"></i>April 13, 2020</span><span className="entry-comment-count"><a href="#comments"><i className="far fa-comment-alt"></i>2</a></span><span className="entry-comment-count"></span>
                        </div>
                        </header>
                        <div className="entry-media alignwide"><img src={ArticleImg} alt="Card image cap" /></div>
                ...
                <ol className="comment-list">
                    ...
                    <article className="comment-body" id="div-comment-1">
                        ...
                        <div className="comment-author vcard"><img className="avatar" alt="profile pic" src={Avatar} height="100" width="100" /><b className="fn"><a className="url" href="https://www.energeticthemes.com/" rel="external nofollow">Anushey Malik</a></b><span className="says">says:</span></div>

                        <div className="comment-metadata"><a href="#">
                            <time datetime="2018-07-29T21:45:09+00:00">July 29, 2019 at 9:45 pm</time></a></div>
